    ...
    <div className="min-h-screen flex" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-slate-50">
        <div className="w-full max-w-md">
          ...
          <Link to="/portal" className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-indigo-600 mb-8 transition-colors">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">IT Administrator Access</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" required value={username} onChange={e => setUsername(e.target.value)}
                    placeholder="admin"
                    className="w-full pl-10 pr-4 py-2.5 border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-slate-50" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type={showPass ? 'text' : 'password'} required value={password} onChange={e => setPassword(e.target.value)}
                    placeholder="••••••••"
                    className="w-full pl-10 pr-10 py-2.5 border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-slate-50" />
              ...
              <div className="p-3 rounded-lg bg-indigo-50 border border-indigo-100">
                ...
                <p className="text-xs text-indigo-600 mt-0.5">Username: <strong>admin</strong> · Password: <strong>admin123</strong></p>
              </div>
