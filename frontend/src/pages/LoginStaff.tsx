...
import { Users, ArrowLeft, Eye, EyeOff, Monitor, Lock, User, LifeBuoy } from 'lucide-react';
    ...
    <div className="min-h-screen flex" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden"
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-4xl font-extrabold text-white leading-tight mb-4">
            Staff<br />Self-Service Portal
          </h2>
          <p className="text-blue-200 text-lg leading-relaxed max-w-xs">
            Report asset issues, track the status of your requests, and stay connected with your IT team.
          </p>

          <div className="mt-10 space-y-3">
            {['Submit helpdesk tickets', 'Track issue status in real-time', 'Scan asset QR codes', 'Personal settings'].map(f => (
          ...
          <div className="mt-8 p-4 rounded-xl bg-white dark:bg-slate-900/10 backdrop-blur-sm border border-white/20">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-white text-sm font-semibold">Workflow Reminder</span>
            </div>
            <p className="text-blue-200 text-xs">Submit a ticket → Admin reviews → Tech team resolves → You're notified</p>
          </div>
        </div>

        <div className="relative z-10">
          <p className="text-blue-300 text-xs">© 2025 Acme Technologies Inc.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-slate-50 dark:bg-slate-900/50">
        <div className="w-full max-w-md">
          ...
          <Link to="/portal" className="inline-flex items-center gap-1.5 text-sm text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:text-blue-400 mb-8 transition-colors">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-8">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h1 className="text-xl font-bold text-slate-900 dark:text-white">Staff Portal</h1>
                <p className="text-xs text-slate-500 dark:text-slate-400">Employee Self-Service</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/30">
                <p className="text-xs text-blue-700 dark:text-blue-400 font-semibold">Demo credentials</p>
                <p className="text-xs text-blue-600 dark:text-blue-400 mt-0.5">Username: <strong>staff</strong> · Password: <strong>staff123</strong></p>
              </div>

              <button type="submit" disabled={loading}
                className="w-full py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors disabled:opacity-60 text-sm shadow-lg shadow-blue-500/25">
