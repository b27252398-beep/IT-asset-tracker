            ...
            <div className="relative z-10 inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 border-b border-slate-100">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg leading-6 font-medium text-slate-900" id="modal-title">Add New Employee</h3>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="relative z-10 inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 border-b border-slate-100">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg leading-6 font-medium text-slate-900">Employee Profile</h3>
                  <button onClick={() => setViewEmp(null)} className="text-slate-400 hover:text-slate-500 cursor-pointer">
                    <X className="w-5 h-5" />
                  </button>
                </div>
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <span className="block text-sm text-slate-900 mt-1">{viewEmp.name}</span>
                    </div>
                    <div>
                      <span className="block text-sm font-medium text-slate-500">Employee ID</span>
                      <span className="block text-sm text-slate-900 mt-1">{viewEmp.id}</span>
                    </div>
                    <div>
                      <span className="block text-sm font-medium text-slate-500">Email Address</span>
                      <span className="block text-sm text-slate-900 mt-1">{viewEmp.email}</span>
                    </div>
                    <div>
                      <span className="block text-sm font-medium text-slate-500">Status</span>
                      <span className="block text-sm text-slate-900 mt-1">{viewEmp.status}</span>
                    </div>
                    <div>
                      <span className="block text-sm font-medium text-slate-500">Department</span>
                      <span className="block text-sm text-slate-900 mt-1">{viewEmp.department}</span>
                    </div>
                    <div>
                      <span className="block text-sm font-medium text-slate-500">Role</span>
                      <span className="block text-sm text-slate-900 mt-1">{viewEmp.role}</span>
                    </div>
                  </div>
                  <div className="bg-slate-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse -mx-6 -mb-6 mt-6 border-t border-slate-100">
